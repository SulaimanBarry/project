...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="height: 60px;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="admin_viewschedule.php"><i class="fa fa-eye" aria-hidden="true"></i> View Student Schedule <span class="sr-only"></span></a>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cog" aria-hidden="true"></i>
          Manage Schedule
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="admin_account.php"><i class="fa fa-user-circle" aria-hidden="true"></i> My Account</a>
          <a class="dropdown-item" href="admin_manageschedule.php"><i class='far fa-edit'></i> Edit Schedule</a>
          <a class="dropdown-item" href="admin_createschedule.php"><i class="fa fa-plus" aria-hidden="true"></i> Add Schedule</a>
    ...
    <ul >
      <li class="nav-item dropdown no-arrow">
              <div class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="photos/<?php echo $_SESSION['admin_image']; ?>" style="width: 50px;height: 40px;">
              </div>
